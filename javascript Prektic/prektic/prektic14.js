...
// Random Function
function randome(n){
    var result2 = Math.random() *n;
    var output = Math.round(result2);
    return output;
}
var merandom = randome(1000);
console.log(merandom);

// Fibenacci Part Start
var fibo =[0,1];
for(var i =2; i <= 10; i++){
